...
def g(x):
    #поскольку стандартное представление x = g(x) не позволяет получить корректное выполнение условие сходимости ( q < 1)
...
if __name__ == "__main__":
    l_iter, r_iter = 0.2, 0.8
    # l_iter, r_iter = -1, -0.1
    x_iter, i_iter = iteration_method((l_iter, r_iter))
    
    l_newton, r_newton = 0.3, 0.8
    # l_newton, r_newton = -0.8, -0.3
